...
void loop() {
  ...
  if (t > 26 && t < 10)    // Обработка значений температуры с датчика DHT11
  {
  ...
  if ( h > 48 && h < 20 )   // Обработка значений влажности с датчика DHT11
  {
  ...
  if (d > 740 && d < 700 )   // Обработка значений давления с датчика BMP280
  {
